...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['project_id'], ['projects.id'], name=op.f('fk_languages_project_id_projects')),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('project_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['project_id'], ['projects.id'], name=op.f('fk_projectPoints_project_id_projects')),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['language_id'], ['languages.id'], name=op.f('fk_project_languages_language_id_languages')),
    sa.ForeignKeyConstraint(['project_id'], ['projects.id'], name=op.f('fk_project_languages_project_id_projects')),
    sa.PrimaryKeyConstraint('id')
    )
